...
[spacemacs layout docs](https://github.com/syl20bnr/spacemacs/blob/66128ffbac8d8a030f849e81698fc5b83a1491ae/doc/DOCUMENTATION.org#layout-key-bindings)

* Credits

This config is heavily inspired by (and often directly copied from):

- [@daviwil's Emacs From Scratch series](https://github.com/daviwil/emacs-from-scratch)
- [@geolessel's Emacs config](https://github.com/geolessel/dotfiles/tree/main/emacs/emacs.d)
